const currentImports = {};
      ...
      let moduleMap = {
"./App":()=>{
      dynamicLoadingCss(["style-CIqC6tEw.css"], false, './App');
      return __federation_import('./__federation_expose_App-Db5T6Zdx.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
