...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true,requiredVersion:'^18.2.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BN8Au471.js', import.meta.url).href),import:true,requiredVersion:'^18.2.0'},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-D29S2ieJ.js', import.meta.url).href),import:true,requiredVersion:'^6.20.0'},'@reduxjs/toolkit':{get:()=>()=>__federation_import(new URL('__federation_shared_@reduxjs/toolkit-BonTQMCh.js', import.meta.url).href),import:true,requiredVersion:'^2.0.1'},'react-redux':{get:()=>()=>__federation_import(new URL('__federation_shared_react-redux-BpXEdWnK.js', import.meta.url).href),import:true,requiredVersion:'^9.0.4'}};
